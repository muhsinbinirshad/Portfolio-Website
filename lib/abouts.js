...
const abouts = [
  {
    timeline: "Jul `23 - Present",
    icon: <BiCode />,
    title: "Cyber Security Engineer",
    subtitle: "Daimler Truck Innovation Center India (DTICI)",
    link: "https://www.daimlertruck.com/en/career/locations/detail/bengaluru-daimler-truck-innovation-center-india-private-limited",
    now: true,
  },
  {
    timeline: "Feb `23 - Jun `23",
    icon: <BiCode />,
