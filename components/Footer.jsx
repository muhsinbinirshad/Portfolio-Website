      ...
      <div className="container xl:max-w-screen-xl lg:flex justify-between mx-auto mt-2 lg:mt-8 mb-12">
        ...
        <section>
          ...
          <div className="flex flex-wrap md:justify-center items-center gap-8 mt-6">
            <GitHub username="AshiqAbdulkhader" />
            <Twitter username="__Ashiq__" />
            <Email mailId="mail@ashiqabdulkhader.dev" />
            <LinkedIn username="muhammed-ashiq-abdul-khader" />
            <HackerRank username="ashiqabdulkhader" />
          </div>
        </section>
      </div>
    </footer>
